                ...
                <dl className="sm:divide-y sm:divide-gray-200">
                    ...
                    <div className="py-4 sm:grid sm:grid-cols-2 sm:gap-4 sm:py-5 sm:px-6">
                        <dd className="mt-1 text-md text-gray-800 sm:col-span-2 sm:mt-0">
                            I’m a full-stack programmer currently working with React, Chat and SMS for Quicken Loans. I work on a React/Redux application that helps us route conversations.
                            <br /><br />
